...
t.data.type?(e.type=t.data.type,e.field=t.data.field,e.message=t.data.message):(e.type="error",e.message=e.errors.unknown)})}}]),e.directive("focus",function(){return{restrict:"A",link:function(e,t){t[0].focus()}}}),e.config(["$routeProvider","$locationProvider",function(e,t){t.html5Mode(!0),e.when("/",{controller:"HomeCtrl",templateUrl:"templates/home.php"}),e.when("/about",{templateUrl:"templates/about.php"}),e.when("/contact",{templateUrl:"templates/contact.php"}),e.otherwise({templateUrl:"templates/other.php"})}])}();